package az.zeynalovv.UberEats.identity.util;
...
public class CryptoUtil {
  ...
  public static byte[] encryptText(PrivateKey privateKey, byte[] plainText)
  ...
  public static byte[] decryptText(PublicKey publicKey, byte[] cipherText)
      throws NoSuchPaddingException, NoSuchAlgorithmException,
      IllegalBlockSizeException, BadPaddingException, InvalidKeyException {
